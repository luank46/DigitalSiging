...
namespace DigitalSigning.Core.Providers
{
    ...
    public class ProviderSignRequest
    {
        ...
        /// <summary>PdfSignatureContexts keyed by FileByteId — persisted between ComputeHashAsync and EmbedSignatureAsync calls.</summary>
        public Dictionary<string, object>? PdfContexts { get; set; }
