...
namespace DigitalSigning.Core.Services.Pdf
{
    ...
    public class PdfSigningService : IPdfSigningService
    {
        ...
        public Task<(byte[] Hash, PdfSignatureContext Context)> ComputeHashAsync(
            byte[] pdfBytes, CancellationToken ct = default)
        {
            ...
            var context = new PdfSignatureContext(preparedPdf, byteRange);
            ...
            string? signatureName = null, CancellationToken ct = default)
        {
            ...
            var preparedPdf = context.PreparedPdf;
            var byteRange = context.ByteRange;
            ...
            var sigHex = cmsHex.PadRight(SignaturePlaceholderLen, '0')[..SignaturePlaceholderLen];
